...
MERGED_ABILITIES: List[Tuple] = [
    ...
    (94, 'Absorb MP', 'Drain MP from an enemy and restore it to yourself.', '{"absorb_mp": {"amount": 25}}', 2, 0, '💧', 'enemy', None, None, None, None, '2025-05-22 15:21:04', 'magic_power'),
    (95, 'Quake', 'Shake the earth to damage enemies.', '{"base_damage": 90}', 1, 0, '🌎', 'enemy', None, 8, None, None, '2025-09-13 00:00:00', 'magic_power'),
    (96, 'Flood', 'Summon a surge of water that crashes into foes.', '{"base_damage": 90}', 1, 0, '🌊', 'enemy', None, 7, None, None, '2025-09-13 00:00:00', 'magic_power'),
    (97, 'Aero', 'Slice enemies with razor-sharp wind.', '{"base_damage": 70}', 1, 0, '🌪️', 'enemy', None, 5, None, None, '2025-09-13 00:00:00', 'magic_power'),
    (98, 'Wind Slash', 'Unleash a cutting gust that tears through foes.', '{"base_damage": 85}', 1, 0, '🍃', 'enemy', None, 5, None, None, '2025-09-13 00:00:00', 'magic_power'),
    (99, "Gaia's Wrath", 'Call on the land itself to crush enemies.', '{"base_damage": 120}', 2, 0, '🪨', 'enemy', None, 8, None, None, '2025-09-13 00:00:00', 'magic_power'),
    (100, 'Ballad of Might', 'A stirring song that raises attack power.', '{"status_effects": [{"name": "Attack Up", "duration": 5}], "status_only": true}', 2, 0, '🎵⚔️', 'self', None, None, None, None, '2025-09-20 00:00:00', 'magic_power'),
    (101, 'Ballad of Guarding', 'A protective melody that raises defense.', '{"status_effects": [{"name": "Defense Up", "duration": 5}], "status_only": true}', 2, 0, '🎵🛡️', 'self', None, None, None, None, '2025-09-20 00:00:00', 'magic_power'),
    (102, 'Ballad of Warding', 'A warding hymn that raises magic defense.', '{"status_effects": [{"name": "Mag.Def Up", "duration": 5}], "status_only": true}', 2, 0, '🎵🔮🛡️', 'self', None, None, None, None, '2025-09-20 00:00:00', 'magic_power'),
    (103, 'Ballad of Clarity', 'A song that heightens magical focus.', '{"status_effects": [{"name": "Magic Up", "duration": 5}], "status_only": true}', 2, 0, '🎵🔮', 'self', None, None, None, None, '2025-09-20 00:00:00', 'magic_power'),
    (104, 'Swift Etude', 'A quick tempo that raises evasion.', '{"status_effects": [{"name": "Evasion Up", "duration": 4}], "status_only": true}', 2, 0, '🎵🎯', 'self', None, None, None, None, '2025-09-20 00:00:00', 'magic_power'),
    (105, 'Healing Carol', 'A gentle carol that restores health over time.', '{"healing_over_time": {"percent": 0.1, "duration": 5}, "hot_name": "Regen"}', 3, 0, '🎵❤️', 'self', None, None, None, None, '2025-09-20 00:00:00', 'magic_power'),
    (106, 'Dissonant Requiem', 'A discordant refrain that weakens defenses.', '{"status_effects": [{"name": "Defense Down", "duration": 3, "chance": 0.75}, {"name": "Mag.Def Down", "duration": 3, "chance": 0.75}], "status_only": true}', 3, 0, '🎵🔽', 'enemy', None, None, None, None, '2025-09-20 00:00:00', 'magic_power'),
    (107, 'Soothing Lullaby', 'A lullaby that can briefly stun a foe.', '{"status_effects": [{"name": "Stun", "duration": 1, "chance": 0.6}], "status_only": true}', 3, 0, '🎵💤', 'enemy', None, None, None, None, '2025-09-20 00:00:00', 'magic_power'),
    (108, 'Silencing Coda', 'A sharp coda that can silence a foe.', '{"status_effects": [{"name": "Silence", "duration": 2, "chance": 0.6}], "status_only": true}', 3, 0, '🎵🤐', 'enemy', None, None, None, None, '2025-09-20 00:00:00', 'magic_power'),
    (109, 'Defend', 'Brace to reduce incoming damage for a short time.', '{"status_effects": [{"name": "Defense Up", "duration": 2}], "status_only": true}', 1, 0, '🛡️', 'self', None, None, None, None, '2025-09-20 00:00:00', 'defense'),
    (110, 'Cover', 'Protect an ally by taking hits meant for them.', '{"status_effects": [{"name": "Defense Up", "duration": 3}], "status_only": true}', 2, 0, '🛡️❤️', 'ally', None, None, None, None, '2025-09-20 00:00:00', 'defense'),
    (111, 'Provoke', 'Draw enemy attention, leaving them exposed.', '{"status_effects": [{"name": "Defense Down", "duration": 2, "chance": 0.6}], "status_only": true}', 1, 0, '📢', 'enemy', None, None, None, None, '2025-09-20 00:00:00', 'attack_power'),
    (112, 'Shield Bash', 'Bash with a shield to damage and possibly stun.', '{"base_damage": 80, "status_effects": [{"name": "Stun", "duration": 1, "chance": 0.3}]}', 1, 0, '🛡️', 'enemy', None, None, None, None, '2025-09-20 00:00:00', 'attack_power'),
    (113, 'Shield Break', 'Crush the foe’s guard, lowering defense.', '{"base_damage": 100, "status_effects": [{"name": "Defense Down", "duration": 3, "chance": 0.5}]}', 1, 0, '🛡️🔽', 'enemy', None, None, None, None, '2025-09-20 00:00:00', 'attack_power'),
    (114, 'Magic Break', 'Shatter magical strength to lower magic power.', '{"magic_power_down": 25}', 1, 0, '🔮🔽', 'enemy', None, None, None, None, '2025-09-20 00:00:00', 'attack_power'),
    (115, 'Speed Break', 'Hinder the target’s speed and reaction time.', '{"status_effects": [{"name": "Slow", "duration": 2, "chance": 0.6}], "status_only": true}', 1, 0, '⏳🔽', 'enemy', None, None, None, None, '2025-09-20 00:00:00', 'attack_power'),
    (116, 'Full Break', 'Cripple the target’s offensive and defensive power.', '{"attack_power_down": 15, "defense_down": 15, "magic_power_down": 15, "magic_defense_down": 15}', 3, 0, '💥🔽', 'enemy', None, None, None, None, '2025-09-20 00:00:00', 'attack_power'),
    (117, 'Cleave', 'A wide, heavy swing that cuts through the foe.', '{"base_damage": 120}', 1, 0, '⚔️', 'enemy', None, None, None, None, '2025-09-20 00:00:00', 'attack_power'),
    (118, 'Double Cut', 'Strike twice in rapid succession.', '{"multi_hit": {"hits": 2, "base_damage": 80, "scaling_stat": "attack_power", "scaling_factor": 1.0}}', 1, 0, '⚔️', 'enemy', None, None, None, None, '2025-09-20 00:00:00', 'attack_power'),
    (119, 'Tame', 'Attempt to tame a weakened beast to fight alongside you.', '{"tame": {"base_chance": 0.35, "hp_bonus": 0.3, "level_penalty": 0.05}}', 2, 0, '🐾', 'enemy', None, None, None, None, '2025-09-25 00:00:00', 'attack_power'),
    (120, 'Train', 'Train a companion beast, boosting its combat prowess.', '{"status_effects": [{"name": "Attack Up", "duration": 3}, {"name": "Defense Up", "duration": 3}], "status_only": true}', 3, 0, '🎯', 'self', None, None, None, None, '2025-09-25 00:00:00', 'attack_power'),
    (121, 'Beast Command', 'Issue a commanding order that disrupts a foe.', '{"base_damage": 70, "status_effects": [{"name": "Evasion Down", "duration": 2, "chance": 0.6}]}', 2, 0, '🪢', 'enemy', None, None, None, None, '2025-09-25 00:00:00', 'attack_power'),
    (122, 'Angelo Search', 'Angelo sniffs out supplies, increasing your chance to find loot.', '{"status_effects": [{"name": "Haste", "duration": 3}, {"name": "Evasion Up", "duration": 3}], "status_only": true}', 0, 0, '🐕', 'self', None, None, None, None, '2025-09-25 00:00:00', 'attack_power'),
    (123, 'Angelo Strike', 'Angelo darts forward with a piercing strike.', '{"base_damage": 160}', 1, 0, '🐕⚔️', 'enemy', None, None, None, None, '2025-09-25 00:00:00', 'attack_power'),
    (124, 'Angelo Recover', 'Angelo restores HP to the party leader.', '{"heal": 120}', 1, 0, '🐕❤️', 'self', None, None, None, None, '2025-09-25 00:00:00', 'magic_power'),
    (125, 'Angelo Shield', 'Angelo protects you with a defensive barrier.', '{"status_effects": [{"name": "Defense Up", "duration": 3}], "status_only": true}', 2, 0, '🐕🛡️', 'self', None, None, None, None, '2025-09-25 00:00:00', 'defense'),
