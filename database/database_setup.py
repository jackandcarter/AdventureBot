...
MERGED_ABILITIES: List[Tuple] = [
    ...
    (54, 'Cross-Slash', 'A sweeping slash that may stun the foe.', '{"base_damage": 200, "status_effects": [{"name": "Stun", "duration": 1, "chance": 0.35}]}', 1, '⚔️', 'enemy', None, None, None, None, '2025-05-11 03:48:29', 'attack_power'),
    (55, 'Meteorain', 'Summon a volley of meteors that strike multiple times.', '{"multi_hit": {"hits": 6, "base_damage": 50, "scaling_stat": "attack_power", "scaling_factor": 1.0}}', 1, '⚔️', 'enemy', None, None, None, None, '2025-05-11 03:48:29', 'attack_power'),
    (56, 'Finishing Touch', 'A decisive blow that can blind the enemy.', '{"base_damage": 400, "status_effects": [{"name": "Blind", "duration": 2, "chance": 0.4}]}', 1, '⚔️', 'enemy', None, None, None, None, '2025-05-11 03:48:29', 'attack_power'),
    (57, 'Omnislash', 'Unleash a flurry of slashes that strike repeatedly.', '{"multi_hit": {"hits": 12, "base_damage": 80, "scaling_stat": "attack_power", "scaling_factor": 1.0}}', 1, '⚔️', 'enemy', None, None, None, None, '2025-05-11 03:48:29', 'attack_power'),
    (58, 'Stagger', 'A punishing strike that can slow the target.', '{"base_damage": 150, "status_effects": [{"name": "Slow", "duration": 2, "chance": 0.35}]}', 1, '⚔️', 'enemy', None, None, None, None, '2025-05-11 03:48:29', 'attack_power'),
    (59, 'Bull Charge', 'Charge the enemy with a chance to stun.', '{"base_damage": 200, "status_effects": [{"name": "Stun", "duration": 1, "chance": 0.25}]}', 1, '⚔️', 'enemy', None, None, None, None, '2025-05-11 03:48:29', 'attack_power'),
    (60, 'Wallop', 'A crushing hit that can lower the enemy’s defense.', '{"base_damage": 300, "status_effects": [{"name": "Defense Down", "duration": 3, "chance": 0.4}]}', 1, '⚔️', 'enemy', None, None, None, None, '2025-05-11 03:48:29', 'attack_power'),
    ...
    (62, 'Grand Lethal', 'A deadly strike that hits harder on weakened foes.', '{"base_damage": 300, "execute": {"threshold": 0.3, "multiplier": 1.5}}', 1, '⚔️', 'enemy', None, None, None, None, '2025-05-11 03:48:29', 'attack_power'),
    (63, 'Bandit', None, '{"mug": {"damage": 100}}', 1, '⚔️', 'enemy', None, None, None, None, '2025-05-11 03:48:29', 'attack_power'),
    (64, 'Master Thief', 'Strike while stealing extra Gil from the target.', '{"mug": {"damage": 150, "steal_multiplier": 1.5}}', 1, '⚔️', 'enemy', None, None, None, None, '2025-05-11 03:48:29', 'attack_power'),
    (65, 'Confuse', 'Scramble the target’s senses and inflict confusion.', '{"base_damage": 120, "status_effects": [{"name": "Confuse", "duration": 2, "chance": 0.5}]}', 1, '⚔️', 'enemy', None, None, None, None, '2025-05-11 03:48:29', 'attack_power'),
    (66, 'Lancet', 'Drain HP and MP from an enemy.', '{"base_damage": 200, "hp_drain_pct": 0.5, "absorb_mp": {"percent_current": 0.25}}', 1, '⚔️', 'enemy', None, None, None, None, '2025-05-11 03:48:29', 'attack_power'),
    (67, 'High Jump', 'Leap high to deliver a stronger jump attack.', '{"base_damage": 200, "scaling_stat": "attack_power", "scaling_factor": 1.3}', 1, '⚔️', 'enemy', None, None, None, None, '2025-05-11 03:48:29', 'attack_power'),
    (68, 'Eye 4 Eye', 'A punishing counterstrike that may stun.', '{"base_damage": 300, "status_effects": [{"name": "Stun", "duration": 1, "chance": 0.2}]}', 1, '⚔️', 'enemy', None, None, None, None, '2025-05-11 03:48:29', 'attack_power'),
    (69, 'Beast Killer', 'Strike beasts with extra force.', '{"base_damage": 400, "bonus_vs_role": {"roles": ["beast"], "multiplier": 1.5}}', 1, '⚔️', 'enemy', None, None, None, None, '2025-05-11 03:48:29', 'attack_power'),
    (70, 'Avalanche', 'An icy onslaught that may freeze foes.', '{"base_damage": 300, "status_effects": [{"name": "Freeze", "duration": 1, "chance": 0.25}]}', 1, '⚔️', 'enemy', None, 2, None, None, '2025-05-11 03:48:29', 'magic_power'),
    (71, 'Tornado', 'Wind magic that tears away a portion of HP.', '{"percent_damage": 0.35}', 1, '⚔️', 'enemy', None, 5, None, None, '2025-05-11 03:48:29', 'magic_power'),
    (72, 'Earthquake', 'A violent quake that may stun enemies.', '{"base_damage": 300, "status_effects": [{"name": "Stun", "duration": 1, "chance": 0.2}]}', 1, '⚔️', 'enemy', None, 8, None, None, '2025-05-11 03:48:29', 'magic_power'),
    (73, 'Meteor', 'Massive meteor impacts strike multiple times.', '{"multi_hit": {"hits": 4, "base_damage": 100, "scaling_stat": "magic_power", "scaling_factor": 1.0}}', 1, '⚔️', 'enemy', None, 4, None, None, '2025-05-11 03:48:29', 'magic_power'),
    (74, 'UltimaBlade', 'Unleash ultimate blade energy for massive damage.', '{"base_damage": 400, "scaling_stat": "attack_power", "scaling_factor": 1.2}', 1, '⚔️', 'enemy', None, 4, None, None, '2025-05-11 03:48:29', 'magic_power'),
    (75, 'MeteorBlade', 'A meteor-infused blade strike that hits repeatedly.', '{"multi_hit": {"hits": 3, "base_damage": 140, "scaling_stat": "attack_power", "scaling_factor": 1.0}}', 1, '⚔️', 'enemy', None, 4, None, None, '2025-05-11 03:48:29', 'magic_power'),
    (76, 'HolyBlade', 'A holy blade strike that may blind foes.', '{"base_damage": 400, "status_effects": [{"name": "Blind", "duration": 2, "chance": 0.3}]}', 1, '⚔️', 'enemy', None, 3, None, None, '2025-05-11 03:48:29', 'magic_power'),
    (77, 'GravijaBlade', 'A gravity-infused strike that reduces enemy HP.', '{"percent_damage": 0.3}', 1, '⚔️', 'enemy', None, 5, None, None, '2025-05-11 03:48:29', 'magic_power'),
    (78, 'Bio II', None, '{"damage_over_time": {"duration": 7, "damage_per_turn": 72}}', 1, '⚔️', 'enemy', None, None, 8, 7, '2025-05-11 03:48:29', 'attack_power'),
    (79, 'Frog', 'Transform the target into a frog, hindering them.', '{"status_effects": [{"name": "Frog", "duration": 2, "chance": 0.6}, {"name": "Slow", "duration": 2, "chance": 0.6}, {"name": "Blind", "duration": 2, "chance": 0.6}], "status_only": true}', 1, '⚔️', 'enemy', None, None, None, None, '2025-05-11 03:48:29', 'attack_power'),
    (80, 'Full-Cure', 'Fully restore HP to the caster.', '{"heal": 9999}', 1, None, 'self', None, None, None, None, '2025-05-11 03:48:29', 'attack_power'),
    (81, 'Reflect', 'Grants a reflective barrier for a short time.', '{"status_effects": [{"name": "Reflect", "duration": 3}], "status_only": true}', 1, None, 'self', None, None, None, None, '2025-05-11 03:48:29', 'attack_power'),
    (82, 'Dbl Holy', 'Cast Holy twice on the enemy.', '{"multi_hit": {"hits": 2, "base_damage": 200, "scaling_stat": "magic_power", "scaling_factor": 1.0}}', 1, '⚔️', 'enemy', None, 3, None, None, '2025-05-11 03:48:29', 'magic_power'),
    (83, 'Dbl Ultima', 'Cast Ultima twice on the enemy.', '{"multi_hit": {"hits": 2, "base_damage": 220, "scaling_stat": "magic_power", "scaling_factor": 1.0}}', 1, '⚔️', 'enemy', None, 4, None, None, '2025-05-11 03:48:29', 'magic_power'),
    (84, 'Dbl Focus', 'Greatly increases magic power for a short time.', '{"status_effects": [{"name": "Magic Up", "duration": 6}], "status_only": true}', 1, None, 'self', None, None, None, None, '2025-05-11 03:48:29', 'magic_power'),
    (85, 'Dbl Cure', 'Heal yourself twice in quick succession.', '{"heal": 500}', 1, None, 'self', None, None, None, None, '2025-05-11 03:48:29', 'magic_power'),
    (86, 'Dbl Flare', 'Cast Flare twice on the enemy.', '{"multi_hit": {"hits": 2, "base_damage": 100, "scaling_stat": "magic_power", "scaling_factor": 1.0}}', 1, '⚔️', 'enemy', None, 4, None, None, '2025-05-11 03:48:29', 'magic_power'),
    (87, 'Dbl Dia', 'Cast Dia twice on the enemy.', '{"multi_hit": {"hits": 2, "base_damage": 100, "scaling_stat": "magic_power", "scaling_factor": 1.0}}', 1, '⚔️', 'enemy', None, 3, None, None, '2025-05-11 03:48:29', 'magic_power'),
    ...
    (90, 'Blue Bullet', 'A blue magic shot that may poison the target.', '{"base_damage": 100, "status_effects": [{"name": "Poisoned", "duration": 3, "chance": 0.35}]}', 0, '⚔️', 'enemy', None, None, None, None, '2025-05-14 01:45:27', 'attack_power'),
